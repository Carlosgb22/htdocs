          ...
          <div class="card-body">
              ...
              <form action="edit.php" method="post">
				...
				<div class="form-group">
					...
					<input type="tel" pattern="[0-9]{9}" title="Un numero de telefono valido consiste en 9 digitos" required 
					class="form-control" id="inputTelefono" placeholder="Introduzca su telefono" name="telefono" value="<?php echo($result['telefono'])?>">
				</div>
